    ...
    if (!loaded) {
        ...
        docRef.get().then(function(doc) {
            if (doc.exists) {
                ...
                Array.from(document.getElementsByClassName("loadSticker")).forEach(element => {
...
function getPlace(code, str) {
    ...
    docRef2.get().then(function(doc) {
        ...
        if (doc.exists) {
            document.getElementById('stickerList').innerHTML += ('<li class="list-group-item">' + str + " from " + doc.data().place + '</li>');
